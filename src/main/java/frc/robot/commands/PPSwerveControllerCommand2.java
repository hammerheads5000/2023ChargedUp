...
public class PPSwerveControllerCommand2 extends CommandBase {
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      PPSwerveControllerCommand2::defaultLogError;

  /**
   * Constructs a new PPSwerveControllerCommand2 that when executed will follow the provided
   ...
   */
  public PPSwerveControllerCommand2(
  ...
  /**
   * Constructs a new PPSwerveControllerCommand22 that when executed will follow the provided
   * trajectory. This command will not return output voltages but ChassisSpeeds from the position
   * controllers which need to be converted to module states and put into a velocity PID.
   *
   * <p>Note: The controllers will *not* set the output to zero upon completion of the path this is
  ...
  public boolean isFinished() {
    System.out.println("SwerveControllerCmdisFinished()" + timer.get() + " out of " + trajectory.getTotalTimeSeconds());
    SmartDashboard.putString("isFinishedAuto", "SwerveControllerCmdisFinished()" + timer.get() + " out of " + trajectory.getTotalTimeSeconds());
  ...
  private static void defaultLogError(Translation2d translationError, Rotation2d rotationError) {
    SmartDashboard.putNumber("PPSwerveControllerCommand2/xErrorMeters", translationError.getX());
    SmartDashboard.putNumber("PPSwerveControllerCommand2/yErrorMeters", translationError.getY());
    SmartDashboard.putNumber(
        "PPSwerveControllerCommand2/rotationErrorDegrees", rotationError.getDegrees());
  }
   ...
   *     active path. This will be called whenever a PPSwerveControllerCommand2 starts
  ...
  public static void setLoggingCallbacks(
    ...
    PPSwerveControllerCommand2.logActiveTrajectory = logActiveTrajectory;
    PPSwerveControllerCommand2.logTargetPose = logTargetPose;
    PPSwerveControllerCommand2.logSetpoint = logSetpoint;
    PPSwerveControllerCommand2.logError = logError;
  }
}
